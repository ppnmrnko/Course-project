<?php
	echo "<table>\n";
		...
		echo "<tr>\n";
			...
			echo "<td><button class='buttonClass' style='width: 300px;' onClick='showForm(\"form4.php?nomer_voinsk_ch=1\");'>Вывод количества вооружения в определённой части</button></td>\n";
		echo "</tr>\n";
		echo "<tr>\n";
			echo "<td colspan='2'><button class='buttonClass' style='width: 604px;' onClick='showForm(\"form5.php?nv=1&rt=1\");'>Вывод количества должностей</button></td>	<!-- nv-звание rt-войсковая часть -->\n";
		echo "</tr>\n";
		echo "<tr>\n";
